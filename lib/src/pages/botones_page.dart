...
class BotonesPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        bottomNavigationBar: _bottomNavigetosBar(context));
  }
  ...
  Widget _bottomNavigetosBar(BuildContext context) {
    return Theme(
  ...
  Widget _botonesRedondeados() {
    return Table(
      children: [
        ...
        TableRow(
          children: [
              _crearBotonRedondeado(Colors.blue, Icons.movie_filter, 'Entreteiment'),
             _crearBotonRedondeado(Colors.green, Icons.cloud, 'Grocery'),
          ]
        ),
        TableRow(
          children: [
            _crearBotonRedondeado(Colors.black, Icons.collections, 'Photos'),
            _crearBotonRedondeado(Colors.red, Icons.border_all, 'General'),
          ]
        )
      ],
